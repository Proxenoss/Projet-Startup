...
document.addEventListener("DOMContentLoaded", function () {//attend que la page soit chargée
                ...
                fileInput.addEventListener("change", () => {
                    ...
                    reader.onload = function (e) {
                        ...
                        newCard.innerHTML = `
                            ...
                            <button class="delete-btn" style="margin-top:10px;background:red;color:white;">Delete</button>
                        `;
    ...
    editBtn.addEventListener("click", function () {//activer le mode admin avec les mots de passe
        if (!isEditing) {
            const login = prompt("Enter the profil name :");//ouvre des prompts pour taper le nom et le mdp
            if (login !== "test") {
            ...
            const confirmExit = confirm("Do you want leave the admin mode");//confirmation avant de quitter
            if (confirmExit) {
                disableEditing();
            }
        }
